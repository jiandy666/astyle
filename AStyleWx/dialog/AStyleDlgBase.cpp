...
BEGIN_EVENT_TABLE( AStyleDlgBase, wxDialog )
	...
	EVT_RADIOBUTTON( ID_STYLE_WEBKIT, AStyleDlgBase::_wxFB_OnStyleClick )
...
AStyleDlgBase::AStyleDlgBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	styleStaticTextBeg = new wxStaticText( m_stylePage, wxID_ANY, wxT("Static box to wrap tab traversal"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_styleNone = new wxRadioButton( m_stylePage, ID_STYLE_NONE, wxT("&None"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	m_styleSizer->Add( m_styleNone, 0, wxALL, 5 );
	
	m_styleAllman = new wxRadioButton( m_stylePage, ID_STYLE_ALLMAN, wxT("&Allman"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleAllman, 0, wxALL, 5 );
	
	m_styleJava = new wxRadioButton( m_stylePage, ID_STYLE_JAVA, wxT("&Java"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleJava, 0, wxALL, 5 );
	
	m_styleKR = new wxRadioButton( m_stylePage, ID_STYLE_KR, wxT("&K && R"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleKR, 0, wxALL, 5 );
	
	m_styleStroustrup = new wxRadioButton( m_stylePage, ID_STYLE_STROUSTRUP, wxT("&Stroustrup"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleStroustrup, 0, wxALL, 5 );
	
	m_styleWhitesmith = new wxRadioButton( m_stylePage, ID_STYLE_WHITESMITH, wxT("&Whitesmith"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleWhitesmith, 0, wxALL, 5 );
	
	m_styleVtk = new wxRadioButton( m_stylePage, ID_STYLE_VTK, wxT("&VTK"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleVtk, 0, wxALL, 5 );
	
	m_styleRatliff = new wxRadioButton( m_stylePage, ID_STYLE_RATLIFF, wxT("&Ratliff"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleRatliff, 0, wxALL, 5 );
	
	m_styleGnu = new wxRadioButton( m_stylePage, ID_STYLE_GNU, wxT("&GNU"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleGnu, 0, wxALL, 5 );
	
	m_styleLinux = new wxRadioButton( m_stylePage, ID_STYLE_LINUX, wxT("Linu&x"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleLinux, 0, wxALL, 5 );
	
	m_styleHorstmann = new wxRadioButton( m_stylePage, ID_STYLE_HORSTMANN, wxT("&Horstmann"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleHorstmann, 0, wxALL, 5 );
	
	m_style1tbs = new wxRadioButton( m_stylePage, ID_STYLE_1TBS, wxT("&1TBS"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_style1tbs, 0, wxALL, 5 );
	
	m_styleGoogle = new wxRadioButton( m_stylePage, ID_STYLE_GOOGLE, wxT("G&oogle"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleGoogle, 0, wxALL, 5 );
	
	m_styleMozilla = new wxRadioButton( m_stylePage, ID_STYLE_MOZILLA, wxT("&Mozilla"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleMozilla, 0, wxALL, 5 );
	
	m_styleWebKit = new wxRadioButton( m_stylePage, ID_STYLE_WEBKIT, wxT("We&bKit"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleWebKit, 0, wxALL, 5 );
	
	m_stylePico = new wxRadioButton( m_stylePage, ID_STYLE_PICO, wxT("&Pico"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_stylePico, 0, wxALL, 5 );
	
	m_styleLisp = new wxRadioButton( m_stylePage, ID_STYLE_LISP, wxT("&Lisp"), wxDefaultPosition, wxDefaultSize, 0 );
	m_styleSizer->Add( m_styleLisp, 0, wxALL, 5 );
	
	wxStaticText* styleStaticTextEnd;
	styleStaticTextEnd = new wxStaticText( m_stylePage, wxID_ANY, wxT("Static box to wrap tab traversal"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_stylePreviewSTC = new wxStyledTextCtrl( m_stylePage, ID_STYLE_PREVIEW_STC, wxDefaultPosition, wxSize( 260,440 ), wxSTATIC_BORDER, wxEmptyString );
	...
	bSizer14->Add( m_stylePreviewSizer, 0, wxALL|wxEXPAND, 5 );
	...
	tabStaticTextBeg = new wxStaticText( m_tabPage, wxID_ANY, wxT("Static box to wrap tab traversal"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_spaceIndent = new wxRadioButton( m_tabPage, ID_INDENTWITH_SPACE, wxT("Indent with &spaces"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
	m_tabSizer->Add( m_spaceIndent, 0, wxALL, 5 );
	
	m_tabIndent = new wxRadioButton( m_tabPage, ID_INDENTWITH_TAB, wxT("Indent with &tabs"), wxDefaultPosition, wxDefaultSize, 0 );
	m_tabSizer->Add( m_tabIndent, 0, wxALL, 5 );
	
	m_forceTabIndent = new wxRadioButton( m_tabPage, ID_INDENTWITH_FTAB, wxT("&Force indent with tabs"), wxDefaultPosition, wxDefaultSize, 0 );
	m_tabSizer->Add( m_forceTabIndent, 0, wxALL, 5 );
	
	wxBoxSizer* m_forceTabSizer;
	m_forceTabSizer = new wxBoxSizer( wxVERTICAL );
	
	m_useTabLength = new wxCheckBox( m_tabPage, ID_USE_TAB_LENGTH, wxT("Change spaces &per tab"), wxDefaultPosition, wxDefaultSize, 0 );
	m_forceTabSizer->Add( m_useTabLength, 0, wxALL, 5 );
	
	m_tabLength = new wxSpinCtrl( m_tabPage, ID_TAB_LENGTH, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 0 );
	...
	m_indentLengthText = new wxStaticText( m_tabPage, wxID_ANY, wxT("Spaces per &Indent"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_indentLength = new wxSpinCtrl( m_tabPage, ID_INDENT_LENGTH, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 10, 0 );
	bSizer26->Add( m_indentLength, 0, wxALL, 5 );
	
	
	bSizer26->Add( 0, 0, 1, wxLEFT, 5 );
	
	m_indentLengthlDisplay = new wxButton( m_tabPage, ID_INDENT_LENGTH_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	m_attachNamespace = new wxCheckBox( m_tabPage, ID_ATTACH_NAMESPACE, wxT("Attach &namespaces"), wxDefaultPosition, wxDefaultSize, 0 );
	m_modifySizer->Add( m_attachNamespace, 0, wxALL, 5 );
	
	m_attachClass = new wxCheckBox( m_tabPage, ID_ATTACH_CLASS, wxT("Attach &classes"), wxDefaultPosition, wxDefaultSize, 0 );
	m_modifySizer->Add( m_attachClass, 0, wxALL, 5 );
	
	m_attachInline = new wxCheckBox( m_tabPage, ID_ATTACH_INLINE, wxT("Attach in&lines"), wxDefaultPosition, wxDefaultSize, 0 );
	m_modifySizer->Add( m_attachInline, 0, wxALL, 5 );
	
	m_attachExternC = new wxCheckBox( m_tabPage, ID_ATTACH_EXTERN_C, wxT("Attach e&xtern C"), wxDefaultPosition, wxDefaultSize, 0 );
	m_modifySizer->Add( m_attachExternC, 0, wxALL, 5 );
	
	m_attachClosingWhile = new wxCheckBox( m_tabPage, ID_ATTACH_CLOSING_WHILE, wxT("Attach closing &while"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_tabPreviewSTC = new wxStyledTextCtrl( m_tabPage, ID_TAB_PREVIEW_STC, wxDefaultPosition, wxSize( 260,440 ), wxSTATIC_BORDER, wxEmptyString );
	...
	m_tabPreviewSizer->Add( m_tabPreviewSTC, 1, wxALL, 5 );
	
	
	bSizer21->Add( m_tabPreviewSizer, 0, wxALL|wxEXPAND, 5 );
	...
	m_indentClassBlocks = new wxCheckBox( m_indentPage, ID_INDENT_CLASS, wxT("Indent cl&ass blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentClassBlocks, 0, wxALL, 5 );
	
	m_indentAccessModifiers = new wxCheckBox( m_indentPage, ID_INDENT_MODIFIER, wxT("Indent access modifie&rs"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentAccessModifiers, 0, wxALL, 5 );
	
	m_indentSwitchBlocks = new wxCheckBox( m_indentPage, ID_INDENT_SWITCH, wxT("Indent &switch blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentSwitchBlocks, 0, wxALL, 5 );
	
	m_indentCaseBlocks = new wxCheckBox( m_indentPage, ID_INDENT_CASE, wxT("Indent &case blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentCaseBlocks, 0, wxALL, 5 );
	
	m_indentNamespaceBlocks = new wxCheckBox( m_indentPage, ID_INDENT_NAMESPACE, wxT("Indent na&mespace blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentNamespaceBlocks, 0, wxALL, 5 );
	
	m_indentAfterParens = new wxCheckBox( m_indentPage, ID_INDENT_AFTER_PAREN, wxT("Indent after &parens"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentAfterParens, 0, wxALL, 5 );
	
	wxBoxSizer* bSizer191;
	bSizer191 = new wxBoxSizer( wxHORIZONTAL );
	
	m_indentContinuation = new wxCheckBox( m_indentPage, ID_INDENT_CONTINUATION, wxT("Indent contin&uation"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer191->Add( m_indentContinuation, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	m_indentContinuationLength = new wxSpinCtrl( m_indentPage, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_WRAP, 0, 10, 0 );
	bSizer191->Add( m_indentContinuationLength, 0, wxALIGN_CENTER_VERTICAL, 5 );
	
	
	m_indentSizer->Add( bSizer191, 0, 0, 5 );
	
	m_indentGotoLabels = new wxCheckBox( m_indentPage, ID_INDENT_GOTO, wxT("Indent &goto labels"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentGotoLabels, 0, wxALL, 5 );
	
	m_indentPreprocBlock = new wxCheckBox( m_indentPage, ID_INDENT_PREPROC_BLOCK, wxT("Indent preproc bloc&k"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentPreprocBlock, 0, wxALL, 5 );
	
	m_indentPreprocDefine = new wxCheckBox( m_indentPage, ID_INDENT_PREPROC_DEFINE, wxT("Indent preproc de&fine"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentPreprocDefine, 0, wxALL, 5 );
	
	m_indentPreprocConditional = new wxCheckBox( m_indentPage, ID_INDENT_PREPROC_COND, wxT("Indent preproc con&ditional"), wxDefaultPosition, wxDefaultSize, 0 );
	m_indentSizer->Add( m_indentPreprocConditional, 0, wxALL, 5 );
	
	m_indentCol1comments = new wxCheckBox( m_indentPage, ID_INDENT_COL1_COMMENT, wxT("Indent col &one comments"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	staticText6 = new wxStaticText( m_indentPage, wxID_ANY, wxT("Mi&nimum conditional option"), wxDefaultPosition, wxDefaultSize, 0 );
	staticText6->Wrap( -1 );
	...
	m_minConditional = new wxChoice( m_indentPage, ID_MIN_CONDITIONAL, wxDefaultPosition, wxDefaultSize, m_minConditionalChoices, 0 );
	...
	m_minConditionalDisplay = new wxButton( m_indentPage, ID_MIN_CONDITIONAL_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	staticText7 = new wxStaticText( m_indentPage, wxID_ANY, wxT("Ma&ximum continuation indent"), wxDefaultPosition, wxDefaultSize, 0 );
	staticText7->Wrap( -1 );
	...
	m_maxContinuation = new wxChoice( m_indentPage, ID_MAX_CONTINUATION, wxDefaultPosition, wxDefaultSize, m_maxContinuationChoices, 0 );
	...
	m_maxContinuationDisplay = new wxButton( m_indentPage, ID_MAX_CONTINUATION_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	m_indentPreviewSTC = new wxStyledTextCtrl( m_indentPage, ID_INDENT_PREVIEW_STC, wxDefaultPosition, wxSize( 260,440 ), wxSTATIC_BORDER, wxEmptyString );
	...
	m_indentPreviewSizer->Add( m_indentPreviewSTC, 1, wxALL, 5 );
	
	
	bSizer18->Add( m_indentPreviewSizer, 0, wxALL|wxEXPAND, 5 );
	...
	m_breakHeaderBlocks = new wxCheckBox( m_padPage, ID_BREAK_HEADER, wxT("Break header &blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_breakHeaderBlocks, 0, wxALL, 5 );
	
	m_breakAllBlocks = new wxCheckBox( m_padPage, ID_BREAK_ALL, wxT("Break &all blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_breakAllBlocks, 0, wxALL, 5 );
	
	m_padOperator = new wxCheckBox( m_padPage, ID_PAD_OPERATOR, wxT("Pad o&perator"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_padOperator, 0, wxALL, 5 );
	
	m_padComma = new wxCheckBox( m_padPage, ID_PAD_COMMA, wxT("Pad comma"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_padComma, 0, wxALL, 5 );
	
	m_padParenOutside = new wxCheckBox( m_padPage, ID_PAD_PAREN_OUT, wxT("Pad paren &outside"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_padParenOutside, 0, wxALL, 5 );
	
	m_padParenInside = new wxCheckBox( m_padPage, ID_PAD_PAREN_IN, wxT("Pad paren &inside"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_padParenInside, 0, wxALL, 5 );
	
	m_padFirstParenOut = new wxCheckBox( m_padPage, ID_PAD_FIRST_PAREN_OUT, wxT("Pad fi&rst paren outside"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_padFirstParenOut, 0, wxALL, 5 );
	
	m_padHeader = new wxCheckBox( m_padPage, ID_PAD_HEADER, wxT("Pad &header"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_padHeader, 0, wxALL, 5 );
	
	m_unpadParen = new wxCheckBox( m_padPage, ID_UNPAD_PAREN, wxT("U&npad paren"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_unpadParen, 0, wxALL, 5 );
	
	m_deleteEmptyLines = new wxCheckBox( m_padPage, ID_DELETE_EMPTY_LINE, wxT("&Delete empty lines"), wxDefaultPosition, wxDefaultSize, 0 );
	m_padSizer->Add( m_deleteEmptyLines, 0, wxALL, 5 );
	
	m_fillEmptyLines = new wxCheckBox( m_padPage, ID_FILL_EMPTY_LINE, wxT("&Fill empty lines"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	staticText10 = new wxStaticText( m_padPage, wxID_ANY, wxT("Align poin&ter"), wxDefaultPosition, wxDefaultSize, 0 );
	staticText10->Wrap( -1 );
	...
	m_alignPointer = new wxChoice( m_padPage, ID_ALIGN_POINTER, wxDefaultPosition, wxDefaultSize, m_alignPointerChoices, 0 );
	...
	m_alignPointerDisplay = new wxButton( m_padPage, ID_ALIGN_POINTER_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	staticText11 = new wxStaticText( m_padPage, wxID_ANY, wxT("Align &reference"), wxDefaultPosition, wxDefaultSize, 0 );
	staticText11->Wrap( -1 );
	m_padSizer->Add( staticText11, 0, wxALL|wxEXPAND, 5 );
	
	wxBoxSizer* bSizer241;
	bSizer241 = new wxBoxSizer( wxHORIZONTAL );
	
	wxArrayString m_alignReferenceChoices;
	m_alignReference = new wxChoice( m_padPage, ID_ALIGN_REFERENCE, wxDefaultPosition, wxDefaultSize, m_alignReferenceChoices, 0 );
	...
	m_alignReferenceDisplay = new wxButton( m_padPage, ID_ALIGN_REFERENCE_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	m_padPreviewSTC = new wxStyledTextCtrl( m_padPage, ID_PAD_PREVIEW_STC, wxDefaultPosition, wxSize( 260,440 ), wxSTATIC_BORDER, wxEmptyString );
	...
	m_padPreviewSizer->Add( m_padPreviewSTC, 1, wxALL, 5 );
	
	
	bSizer11->Add( m_padPreviewSizer, 0, wxALL|wxEXPAND, 5 );
	...
	m_breakClosingBraces = new wxCheckBox( m_formatPage, ID_BREAK_CLOSING, wxT("Break &closing braces"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_breakClosingBraces, 0, wxALL, 5 );
	
	m_breakElseIf = new wxCheckBox( m_formatPage, ID_BREAK_ELSEIF, wxT("Break &else/if statements"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_breakElseIf, 0, wxALL, 5 );
	
	m_breakOneLineHeaders = new wxCheckBox( m_formatPage, ID_BREAK_OL_HEADERS, wxT("Break one line &headers"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_breakOneLineHeaders, 0, wxALL, 5 );
	
	m_addBraces = new wxCheckBox( m_formatPage, ID_ADD_BRACES, wxT("&Add braces"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_addBraces, 0, wxALL, 5 );
	
	m_addOneLineBraces = new wxCheckBox( m_formatPage, ID_ADD_OL_BRACES, wxT("Add &one line braces"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_addOneLineBraces, 0, wxALL, 5 );
	
	m_removeBraces = new wxCheckBox( m_formatPage, ID_REMOVE_BRACES, wxT("&Remove braces"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_removeBraces, 0, wxALL, 5 );
	
	m_breakReturnType = new wxCheckBox( m_formatPage, ID_BREAK_RETURN_TYPE, wxT("Break ret&urn type"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_breakReturnType, 0, wxALL, 5 );
	
	m_breakReturnTypeDecl = new wxCheckBox( m_formatPage, ID_BREAK_RETURN_TYPE_DECL, wxT("Break return type &decl"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_breakReturnTypeDecl, 0, wxALL, 5 );
	
	m_attachReturnType = new wxCheckBox( m_formatPage, ID_ATTACH_RETURN_TYPE, wxT("Attach retur&n type"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_attachReturnType, 0, wxALL, 5 );
	
	m_attachReturnTypeDecl = new wxCheckBox( m_formatPage, ID_ATTACH_RETURN_TYPE_DECL, wxT("Attach return type dec&l"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_attachReturnTypeDecl, 0, wxALL, 5 );
	
	m_keepOneLineBlocks = new wxCheckBox( m_formatPage, ID_KEEP_OL_BLOCKS, wxT("Keep one line &blocks"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_keepOneLineBlocks, 0, wxALL, 5 );
	
	m_keepOneLineStatements = new wxCheckBox( m_formatPage, ID_KEEP_OL_STATEMENTS, wxT("Keep one line &statements"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_keepOneLineStatements, 0, wxALL, 5 );
	
	m_convertTabs = new wxCheckBox( m_formatPage, ID_CONVERT_TABS, wxT("Convert &tabs"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_convertTabs, 0, wxALL, 5 );
	
	m_closeTemplates = new wxCheckBox( m_formatPage, ID_CLOSE_TEMPLATES, wxT("Close tem&plates"), wxDefaultPosition, wxDefaultSize, 0 );
	m_formatSizer->Add( m_closeTemplates, 0, wxALL, 5 );
	
	m_removeCommentPrefix = new wxCheckBox( m_formatPage, ID_REMOVE_COMMENT_PREFIX, wxT("Remove co&mment prefix"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	staticText12 = new wxStaticText( m_formatPage, wxID_ANY, wxT("Ma&ximum code length"), wxDefaultPosition, wxDefaultSize, 0 );
	staticText12->Wrap( -1 );
	...
	m_maxCodeLength = new wxChoice( m_formatPage, ID_MAX_CODE_LENGTH, wxDefaultPosition, wxDefaultSize, m_maxCodeLengthChoices, 0 );
	...
	m_maxCodeLengthDisplay = new wxButton( m_formatPage, ID_MAX_CODE_LENGTH_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	m_breakAfterLogical = new wxCheckBox( m_formatPage, ID_BREAK_AFTER_LOGICAL, wxT("Brea&k after logical"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_formatPreviewSTC = new wxStyledTextCtrl( m_formatPage, ID_FORMAT_PREVIEW_STC, wxDefaultPosition, wxSize( 260,440 ), wxSTATIC_BORDER, wxEmptyString );
	...
	m_formatPreviewSizer->Add( m_formatPreviewSTC, 1, wxALL, 5 );
	
	
	bSizer12->Add( m_formatPreviewSizer, 0, wxALL|wxEXPAND, 5 );
	...
	m_padMethodPrefix = new wxCheckBox( m_otherPage, ID_PAD_METHOD_PREFIX, wxT("Pad method &prefix"), wxDefaultPosition, wxDefaultSize, 0 );
	m_otherSizer->Add( m_padMethodPrefix, 0, wxALL, 5 );
	
	m_unpadMethodPrefix = new wxCheckBox( m_otherPage, ID_UNPAD_METHOD_PREFIX, wxT("Unpad method p&refix"), wxDefaultPosition, wxDefaultSize, 0 );
	m_otherSizer->Add( m_unpadMethodPrefix, 0, wxALL, 5 );
	
	m_padReturnType = new wxCheckBox( m_otherPage, ID_PAD_RETURN_TYPE, wxT("Pad return &type"), wxDefaultPosition, wxDefaultSize, 0 );
	m_otherSizer->Add( m_padReturnType, 0, wxALL, 5 );
	
	m_unpadReturnType = new wxCheckBox( m_otherPage, ID_UNPAD_RETURN_TYPE, wxT("Unpad return t&ype"), wxDefaultPosition, wxDefaultSize, 0 );
	m_otherSizer->Add( m_unpadReturnType, 0, wxALL, 5 );
	
	m_padParamType = new wxCheckBox( m_otherPage, ID_PAD_PARAM_TYPE, wxT("Pad param &type"), wxDefaultPosition, wxDefaultSize, 0 );
	m_otherSizer->Add( m_padParamType, 0, wxALL, 5 );
	
	m_unpadParamType = new wxCheckBox( m_otherPage, ID_UNPAD_PARAM_TYPE, wxT("Unpad param t&ype"), wxDefaultPosition, wxDefaultSize, 0 );
	m_otherSizer->Add( m_unpadParamType, 0, wxALL, 5 );
	
	m_alignMethodColon = new wxCheckBox( m_otherPage, ID_ALIGN_METHOD_COLON, wxT("Align &method colons"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	staticText121 = new wxStaticText( m_otherPage, wxID_ANY, wxT("Pad method &colons"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_padMethodColon = new wxChoice( m_otherPage, ID_PAD_METHOD_COLON, wxDefaultPosition, wxDefaultSize, m_padMethodColonChoices, 0 );
	...
	m_padMethodColonDisplay = new wxButton( m_otherPage, ID_PAD_METHOD_COLON_DISPLAY, wxEmptyString, wxDefaultPosition, wxSize( 17,18 ), 0 );
	...
	m_otherPreviewSTC = new wxStyledTextCtrl( m_otherPage, ID_OTHER_PREVIEW_STC, wxDefaultPosition, wxSize( 260,440 ), wxSTATIC_BORDER, wxEmptyString );
	...
	m_otherPreviewSizer->Add( m_otherPreviewSTC, 1, wxALL, 5 );
	
	
	bSizer121->Add( m_otherPreviewSizer, 0, wxALL|wxEXPAND, 5 );
