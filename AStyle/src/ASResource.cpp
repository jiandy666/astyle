...
bool ASBase::findKeyword(const string& line, int i, const string& keyword1, const string& keyword2, const string& keyword3) const
{
	return findKeyword(line, i, keyword1) || findKeyword(line, i, keyword2) || findKeyword(line, i, keyword3);
}
